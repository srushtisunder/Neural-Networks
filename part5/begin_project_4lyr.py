...
w1, b1 = init_weights(36, numberOfNeuron1), init_bias(numberOfNeuron1) #weights and biases from input to hidden layer
w2 ,b2 = init_weights(numberOfNeuron1, numberOfNeuron2, logistic=False), init_bias(numberOfNeuron2)
w3, b3 = init_weights(numberOfNeuron2, 6, logistic=False), init_bias(6) #weights and biases from hidden to output layer
